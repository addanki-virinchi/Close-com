...
CSV_PATH = "navigation_links.csv"
LOG_PATH = "download_html.log"
...
def filename_for(link_text: str, url: str, used_names: set) -> str:
    ...
    try:
        for index, row in enumerate(rows, start=1):
            ...
            try:
                ...
                filename = filename_for(link_text, url, used_names)
